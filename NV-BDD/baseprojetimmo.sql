...
--
-- Hôte : localhost
-- Généré le : mar. 04 avr. 2023 à 11:51
...
INSERT INTO `biens` (`idBien`, `descript`, `prix`, `adresse`, `idVille`, `codeP`, `surfBien`, `surfJardin`, `nbPièce`, `idType`, `titre`) VALUES
...
INSERT INTO `ville` (`idVille`, `libelle`) VALUES
(1, 'Tourcoing'),
(2, 'Wattrelos'),
(3, 'Roubaix'),
...
--
ALTER TABLE `biens`
  ADD CONSTRAINT `biens_ibfk_1` FOREIGN KEY (`idVille`) REFERENCES `ville` (`idVille`);
