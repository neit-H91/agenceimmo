...
--
-- Hôte : localhost
-- Généré le : mar. 14 mars 2023 à 13:18
...
(5, 'Ce grand terrain vous permettera de concrétiser vous projets les plus fous, immeuble(s), maison(s), les deux, rien n\'est impossible avec autant de place.', 450000, '99 Rue de la piscine', 'Roubaix', '59600', 4000, 0, 0, 3, 'Terrain vague a vendre'),
(6, 'Terrain Plat', 1500000, 'rue de la croix', 'Roubaix', '59390', 1500, 0, 0, 3, 'Ce terrain à beau être vide, il est grand, beau, spacieux, tout vos projets seront à l\'aise ici.'),
(7, 'Ce local peut servir de stockage d\'appoint si nécéssaire, soixante mètre carré ce n\'est pas rien.', 60000, '101 bis Rue Yves Montand', 'Tourcoing', '59200', 60, 0, 1, 4, 'Local de 60m2'),
...
--
ALTER TABLE `biens`
  MODIFY `idBien` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
COMMIT;
